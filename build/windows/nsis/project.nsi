...
####
## !define INFO_PROJECTNAME    "my-project" # Default "mercury"
## !define INFO_COMPANYNAME    "My Company" # Default "Mercury"
## !define INFO_PRODUCTNAME    "My Product Name" # Default "Mercury"
